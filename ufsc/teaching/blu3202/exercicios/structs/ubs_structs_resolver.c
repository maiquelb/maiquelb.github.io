...
// ***** Exercício 1 ********
//
// Definir uma struct que armazene os dados das UBSs.
// A struct deve produzir um novo tipo de dado chamado "Ubs"
// Os dados a serem armazenados são: CNES, UF, IBGE, Logradouro, Bairro, Latitude, Lontgitude
